...
If the required functionality is clearly present and reasonably
implemented, prefer FULL MARKS.
...
Use EXACTLY the rubric criterion names as the keys in "scores".

The JSON must have this structure:

{{
  "scores": {{
    "Task 1 – PDF Loading & Document Processing": 15,
    "Task 2 – Text Chunking": 15,
    "Task 3 – Embeddings & ChromaDB": 20,
    "Task 4 – Retrieval & RAG Answer Generation": 25,
    "Task 5 – Final PDF RAG Application": 25
  }},
...
Do NOT include a separate score outside the five task scores.

The application will calculate the final Total Score out of 100.
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Be implementation-tolerant and award full marks "
                    "when the intended requirement is reasonably satisfied."
                ),
            },
            {
                "role": "user",
...
if st.button(
    ...
    with pd.ExcelWriter(
        ...
        # Sheet 1: exactly the requested final report
        final_columns = [
            "Participant",
            "Task 1 – PDF Loading & Document Processing",
            "Task 2 – Text Chunking",
